...
export class EVMScriptRegistry__factory {
  static readonly abi = _abi
  static createInterface(): EVMScriptRegistryInterface {
    return new Interface(_abi) as EVMScriptRegistryInterface
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): EVMScriptRegistry {
    return new Contract(address, _abi, runner) as unknown as EVMScriptRegistry
  }
}
