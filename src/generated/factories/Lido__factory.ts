...
export class Lido__factory {
  ...
  static createInterface(): LidoInterface {
    return new Interface(_abi) as LidoInterface
  }
  static connect(address: string, runner?: ContractRunner | null): Lido {
    return new Contract(address, _abi, runner) as unknown as Lido
  }
}
