...
import type { Finance, FinanceInterface } from '../Finance'
...
export class Finance__factory {
  static readonly abi = _abi
  static createInterface(): FinanceInterface {
    return new Interface(_abi) as FinanceInterface
  }
  static connect(address: string, runner?: ContractRunner | null): Finance {
    return new Contract(address, _abi, runner) as unknown as Finance
  }
}
